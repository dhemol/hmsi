									...
									<div class="navbar-collapse">	
										<div class="nav-inner">	
											<ul class="nav main-menu menu navbar-nav">
													...
													<li class="active"><a href="#">PROFILE<i class="ti-angle-down"></i></a>
														<ul class="dropdown">
															<li><a href="visimisi.php">VISI & MISI</a></li>
															<li class="active"><a href="strukturorg.php">STRUKTUR ORGANISASI</a></li>
														</ul>
													</li>												
					...
					<div class="col-12">
						<div class="bread-inner">
							<ul class="bread-list">
                                ...
                                <li><a href="#">PROFILE<i class="ti-arrow-right"></i></a></li>
								<li class="active"><a href="strukturorg.php">STRUKTUR ORGANISASI</a></li>
							</ul>
						</div>
					</div>
			...
			<div class="container">
				...
				<div class="col-lg-8 col-12">
						<div class="main-sidebar">
							<!-- Single Widget -->
							<?php
								$query = mysqli_query($con, "SELECT * FROM profil LIMIT 1,1");
									while ($data1 = mysqli_fetch_assoc($query)) {
							?>
							<div class="single-widget recent-post">
								<h3 class="title"><?=$data1['isi_profil']?></h3>
								<!-- Single Post -->
								<div class="blog-detail">
										<div class="content">
											<img src="admin/<?= $data1['img_profil']?>">
										</div>
									</div>
								<!-- End Single Post -->															
							</div>
