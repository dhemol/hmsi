									...
									<div class="navbar-collapse">	
										<div class="nav-inner">	
											<ul class="nav main-menu menu navbar-nav">
													...
													<li class="active"><a href="event.php">EVENT<span class="new">New</span></a>
													</li>								
				...
				<div class="col-lg-6 col-12 padding-left">
					<div class="content">
						<div class="heading-block">
							<p class="small-title"><h1>HMSI UNPAM PROUDLY PRESENT</h1></p>
							<h3><a href="blog-details.php?id=<?= $data1['id_berita']?>"class="title"><?= $data1['headnews'] ?></a></h3>
							<p class="text"><?= $data1['isi_berita']?></p>
							<h1 class="price">YUK BISA YUK</h1>
							<p class="small-title">JUST SHOW YOUR SKILLS</p>
