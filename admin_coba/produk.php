                        ...
                        <ul class="metismenu" id="menu">
							...
							<li  class="active">
                                ...
                                <ul class="collapse">
                                    ...
                                    <li  class="active"><a href="produk.php">Berita</a></li>
                                ...
                                <div class="d-sm-flex justify-content-between align-items-center">
                                    ...
                                    <div class="data-tables datatable-dark">
										 <table id="dataTable3" class="display" style="width:100%"><thead class="thead-dark">
											...
											<?php 
											$brgs=mysqli_query($con,"SELECT * from kategori k, produk p where k.idkategori=p.idkategori order by idproduk ASC");
											$no=1;
					...
					<div class="modal-content">
						...
						<form action="produk.php" method="post" enctype="multipart/form-data" >
								...
								<div class="form-group">
									...
									<?php
									$det=mysqli_query($con,"select * from kategori order by namakategori ASC")or die(mysqli_error());
