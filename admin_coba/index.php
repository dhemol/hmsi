<?php 
	...
	$itungcust = mysqli_query($con,"select count(userid) as jumlahcust from login where role='Member'");
	$itungcust2 = mysqli_fetch_assoc($itungcust);
	$itungcust3 = $itungcust2['jumlahcust'];
	
	$itungorder = mysqli_query($con,"select count(idcart) as jumlahorder from cart where status not like 'Selesai' and status not like 'Canceled'");
	$itungorder2 = mysqli_fetch_assoc($itungorder);
	$itungorder3 = $itungorder2['jumlahorder'];
	
	$itungtrans = mysqli_query($con,"select count(orderid) as jumlahtrans from konfirmasi");
...
<head>
    ...
    <title>Admin Panel - HMSI UNPAM</title>
                            ...
                            <div class="single-report mb-xs-30">
                                <div class="s-report-inner pr--20 pt--30 mb-3">
                                    ...
                                    <div class="s-report-title d-flex justify-content-between">
                                        <h4 class="header-title mb-0">Proposal</h4>
                                    </div>
                        ...
                        <div class="col-md-3">
                            <div class="single-report">
                                <div class="s-report-inner pr--20 pt--30 mb-3">
                                    ...
                                    <div class="s-report-title d-flex justify-content-between">
                                        <h4 class="header-title mb-0">Agenda</h4>
                                    </div>
                                    <div class="d-flex justify-content-between pb-2">
						...
						<div class="col-md-3">
                            <div class="single-report mb-xs-30">
                                <div class="s-report-inner pr--20 pt--30 mb-3">
                                    ...
                                    <div class="s-report-title d-flex justify-content-between">
                                        <h4 class="header-title mb-0">Rekap Data</h4>
                                    </div>
                                    <div class="d-flex justify-content-between pb-2">
                        ...
                        <div class="col-md-3">
                            <div class="single-report mb-xs-30">
                                <div class="s-report-inner pr--20 pt--30 mb-3">
                                    ...
                                    <div class="s-report-title d-flex justify-content-between">
                                        <h4 class="header-title mb-0">Organisasi</h4>
                                    </div>
                                    <div class="d-flex justify-content-between pb-2">
                                        <h1><?php echo $itungtrans3 ?></h1>
                                    </div>
