...
<?php 
	...
	if(isset($_POST['adduser']))
	{
		...
		$tambahuser = mysqli_query($con,"insert into login values('','$username','$password')");
		if ($tambahuser){
                ...
                <div class="menu-inner">
                    <nav>
                        <ul class="metismenu" id="menu">
							...
							<li  class="active"><a href="user.php"><span>Kelola Pengurus</span></a></li>
                            <li>
                                ...
                                <div class="d-sm-flex justify-content-between align-items-center">
                                    ...
                                    <div class="data-tables datatable-dark">
										 <table id="dataTable3" class="display" style="width:100%"><thead class="thead-dark">
											...
											<?php 
											$brgs=mysqli_query($con,"SELECT * from login where role='Admin' order by userid ASC");
											$no=1;
