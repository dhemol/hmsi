					...
					<div class="row">
						<div class="col-lg-12 col-12">
							<div class="form-main">
                                ...
                                <?php
							$id = $_GET['id'];
							$query = mysqli_query($con,"SELECT * FROM profil where id='$id'") or die(mysqli_error());
							$data = mysqli_fetch_array($query);
							?>
								<form name="edit_user" class="form" method="post" action="update-profil.php">
									<div class="row">
                                            <div class="col-lg-12 col-12">
												<div class="form-group">
													<label>ISI PROFIL<span>*</span></label>
													<textarea name="isi_profil" type="text" class="form-control" placeholder="" value="<?php echo $data['isi_profil']; ?>"></textarea>
												</div>
											</div>
                                            <div class="col-lg-12 col-12">
												<div class="form-group">
													<label>IMAGE PROFIL<span>*</span></label>
													<?php echo '<img src="'.$data['img_profil'].'">'; ?>
													<input name="img_profil" type="file" class="input-file uniform_on" id="fileInput">
													<input name="img_profil" type="text" class="input-file uniform_on" id="fileInput" placeholder="Isi dengan link gambar">
												</div>
											</div>
                                            <div class="col-lg-12 col-12">
												<div class="form-group">
													<label>MODIFIED DATE<span>*</span></label>
													<textarea name="modified_date" type="text" class="form-control" placeholder="" value="<?php echo $data['modified_date']; ?>"></textarea>
												</div>
											</div>
											<div class="col-12">
