		...
		<div class="container">
			<div class="row">
						...
						if (!empty($_GET['message']) && $_GET['message'] == 'success') {
							...
							echo '<h4>Success Add Message</h4>';
							echo '</div>';
						}
						else if (!empty($_GET['message']) && $_GET['message'] == 'update') {
							echo '<div class="alert alert-success">' ;
							echo '<button type="button" class="close" data-dismiss="alert">&times;</button>'; 
							echo '<h4>Success Update Message</h4>';
							echo '</div>';
						}
						else if (!empty($_GET['message']) && $_GET['message'] == 'delete') {
							echo '<div class="alert alert-success">' ;
							echo '<button type="button" class="close" data-dismiss="alert">&times;</button>'; 
							echo '<h4>Success Delete Message</h4>';
							echo '</div>';
						}
                                        ...
                                        <tbody>
											...
											?>
												<tr>
													...
													<td align="center"><a href="edit-pesan.php?id=<?php echo $data['id']; ?>" class="btn"><i class="icon-edit"></i>Edit</a></td>
													<td align="center"><a href="delete-pesan.php?id=<?php echo $data['id']; ?>" class="btn"><i class="icon-trash"></i>Delete</a></td>										
												</tr>
											<?php
												$no++;	
											}
					...
					<div class="total-amount">
						<div class="row">
							...
							<div class="col-lg-5 col-12">
								<div class="right">
									<div class="button5">
										<a href="tambah-pesan.php" class="btn">Add Message</a>
									</div>
								</div>
							</div>
						</div>
