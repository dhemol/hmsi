					...
					<div class="row">
						<div class="col-lg-12 col-12">
							<div class="form-main">
								...
								<form name="input_faq" class="form" method="post" action="insert-faq.php">
									<div class="row">
											<div class="col-lg-12 col-12">
												<div class="form-group">
													<label>Question<span>*</span></label>
													<textarea name="question" type="text" class="form-control" placeholder=""></textarea>
												</div>
											</div>
                                            <div class="col-lg-12 col-12">
												<div class="form-group">
													<label>Answer<span>*</span></label>
													<textarea name="answer" type="text" class="form-control" placeholder=""></textarea>
												</div>
											</div>
											<div class="col-12">
