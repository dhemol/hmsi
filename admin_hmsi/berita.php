                                        ...
                                        <tbody>
											...
											?>
												<tr>
													...
													<td><?= $data['headnews']; ?></td>
													<td><?= '<img src="'.$data['gambar_berita'].'"'; ?></td>
													<td><?= $data['isi_berita']; ?></td>
                                                    <td><?= $data['pic_berita']; ?></td>
                                                    <td><?= $data['created_date']; ?></td>
													<td><?= $data['created_time']; ?></td>
													<td><?= $data['modified_date']; ?></td>
													<td><?= $data['event_date']; ?></td>											
                                                    <td><a href="edit-berita.php?id=<?php echo $data['id_berita']; ?>" class="btn"><i class="icon-edit"></i>Edit</a></td>
													<td><a href="delete-berita.php?id=<?php echo $data['id_berita']; ?>" class="btn" onclick="return confirm('Anda Yakin ?')")><i class="remove-icon"></i>Hapus</a></td>
												</tr>
											<?php	
											}
											?>
			...
			<div class="total-amount">
						<div class="row">
							...
							<div class="col-lg-5 col-12">
								<div class="right">
									<div class="button5">
										<a href="tambah-berita.php" class="btn">Add NEWS</a>
									</div>
								</div>
							</div>
						</div>
