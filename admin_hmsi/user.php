                                        ...
                                        <tbody>
											...
											?>
												<tr>
													...
													<td align="center"><a href="edit-user.php?id=<?php echo $data['id']; ?>" class="btn"><i class="icon-edit"></i>Edit</a></td>
													<td align="center"><a href="delete-user.php?id=<?php echo $data['id']; ?>" class="btn"><i class="icon-trash"></i>Delete</a></td>
													</tr>
											<?php
												$no++;
											}
