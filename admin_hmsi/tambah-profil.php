					...
					<div class="row">
						<div class="col-lg-12 col-12">
							<div class="form-main">
								...
								<form name="input_faq" class="form" method="post" action="insert-profil.php">
									<div class="row">
											<div class="col-lg-12 col-12">
												<div class="form-group">
													<label>ISI PROFIL<span>*</span></label>
													<textarea name="isi_profil" type="text" class="form-control" placeholder=""></textarea>
												</div>
											</div>
                                            <div class="col-lg-12 col-12">
												<div class="form-group">
                                            ...
                                            <div class="col-lg-12 col-12">
												<div class="form-group">
													...
													<textarea name="modified_date" type="text" class="form-control" placeholder=""></textarea>
												</div>
											</div>
											<div class="col-12">
