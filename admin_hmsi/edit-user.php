					...
					<div class="row">
						<div class="col-lg-12 col-12">
							<div class="form-main">
                                ...
                                <?php
							$id = $_GET['id'];
							$query = mysqli_query($con,"select * from admin_hmsi where id='$id'") or die(mysqli_error());
							$data = mysqli_fetch_array($query);
							?>
								<form name="edit_user" class="form" method="post" action="update-user.php">
									<div class="row">
										<div class="col-lg-12 col-12">
											...
											<div class="col-lg-12 col-12">
												<div class="form-group">
													...
													<input name="nama_lengkap" type="text" class="form-control" placeholder="Nama Lengkap" value="<?php echo $data['nama_lengkap']; ?>">
												</div>
											</div>
											<div class="col-lg-12 col-12">
												<div class="form-group">
													<label>Email<span>*</span></label>
													<input name="Email" type="email" class="form-control" placeholder="email" value="<?php echo $data['Email']; ?>">
												</div>
											</div>
											<div class="col-lg-12 col-12">
												<div class="form-group">
													<label>Password<span>*</span></label>
													<input name="password" type="password" class="form-control" placeholder="password"  value="<?php echo $data['password']; ?>">>
												</div>	
											</div>
											<div class="col-12">
