					...
					<div class="row">
						<div class="col-lg-12 col-12">
							<div class="form-main">
                                ...
                                <?php
							$id = $_GET['id'];
							$query = mysqli_query($con,"SELECT * FROM faq where id='$id'") or die(mysqli_error());
							$data = mysqli_fetch_array($query);
							?>
								<form name="edit_user" class="form" method="post" action="update-faq.php">
									<div class="row">
                                            <div class="col-lg-12 col-12">
												<div class="form-group">
													<label>Question<span>*</span></label>
													<textarea name="question" type="text" class="form-control" placeholder="" value="<?php echo $data['question']; ?>"></textarea>
												</div>
											</div>
                                            <div class="col-lg-12 col-12">
												<div class="form-group">
													<label>Answer<span>*</span></label>
													<textarea name="answer" type="text" class="form-control" placeholder="" value="<?php echo $data['answer']; ?>"></textarea>
												</div>
											</div>
											<div class="col-12">
