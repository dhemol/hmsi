					...
					<div class="row">
						<div class="col-lg-12 col-12">
							<div class="form-main">
                                ...
                                <?php
							$id = $_GET['id'];
							$query = mysqli_query($con,"select * from hubungi where id='$id'") or die(mysqli_error());
							$data = mysqli_fetch_array($query);
							?>
								<form name="edit_pesan" class="form" method="post" action="update-pesan.php">
									<div class="row">
                                    <div class="col-lg-6 col-12">
											<div class="form-group">
												<label>Your Name<span>*</span></label>
												<input name="nama_lengkap" type="text" class="form-control" placeholder="" value="<?= $data['nama_lengkap']; ?>">
											</div>
										</div>
										<div class="col-lg-6 col-12">
											<div class="form-group">
												<label>Your Subjects<span>*</span></label>
												<input name="subject" type="text" class="form-control" placeholder="" value="<?= $data['subject']; ?>">
											</div>
										</div>
										<div class="col-lg-6 col-12">
											<div class="form-group">
												<label>Your Email<span>*</span></label>
												<input name="email" type="email" class="form-control" placeholder="" value="<?= $data['email']; ?>">
											</div>	
										</div>
										<div class="col-lg-6 col-12">
											<div class="form-group">
												<label>Your Phone<span>*</span></label>
												<input name="no_hp" type="text" class="form-control" placeholder="" value="<?= $data['no_hp']; ?>">
											</div>	
										</div>
										<div class="col-12">
											<div class="form-group message">
												<label>your message<span>*</span></label>
												<textarea name="pesan" class="form-control" placeholder="" value="<?= $data['pesan']; ?>"></textarea>
											</div>
										</div>
											<div class="col-12">
