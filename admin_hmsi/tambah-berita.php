					...
					<div class="row">
						<div class="col-12">
							<div class="form-main">
								...
								<form name="input_berita" enctype="multipart/form-data" class="form" method="post" action="insert-berita.php">
									<div class="row">
										<div class="col-lg-12 col-12">
											<div class="form-group">
												<label>ID BERITA<span>*</span></label>
												<input name="id_berita" type="text" class="form-control" value="" placeholder="">
											</div>
											</div>
											<div class="col-lg-12 col-12">
												<div class="form-group">
													<label>ID KATEGORI<span>*</span></label>
													<input name="id_kategori" type="text" class="form-control" placeholder="" value="">
												</div>	
                                            </div>
											<div class="col-lg-12 col-12">
												<div class="form-group">
													<label>HEADNEWS<span>*</span></label>
													<input name="headnews" type="text" class="form-control" placeholder="" value="">
												</div>	
                                            </div>
											<div class="col-lg-12 col-12">
												<div class="form-group">
                                            ...
                                            <div class="col-lg-12 col-12">
												<div class="form-group">
													...
													<textarea name="isi_berita" type="text" class="form-control" placeholder="" style="width: 670px; height: 200px"></textarea>
												</div>	
                                            </div>
                                            <div class="col-lg-12 col-12">
												<div class="form-group">
													<label>PIC BERITA<span>*</span></label>
													<input name="pic_berita" type="text" class="form-control" placeholder="" value="">
                                            </div>
											</div>
											<div class="col-lg-12 col-12">
												<div class="form-group">
													<label>CREATED DATE<span>*</span></label>
													<input name="created_date" type="date" class="form-control" placeholder="" value="">
                                            </div>
											</div>
											<div class="col-lg-12 col-12">
												<div class="form-group">
													<label>CREATED TIME<span>*</span></label>
													<input name="created_time" type="text" class="form-control" placeholder="" value="">
                                            </div>
											</div>
											<div class="col-lg-12 col-12">
												<div class="form-group">
													<label>MODIFIED DATE<span>*</span></label>
													<input name="modified_date" type="date" class="form-control" placeholder="" value="">
                                            </div>
											</div>
											<div class="col-lg-12 col-12">
												<div class="form-group">
													<label>EVENT DATE<span>*</span></label>
													<input name="event_date" type="date" class="form-control" placeholder="" value="">
                                            </div>
											</div>
											<div class="col-12">
